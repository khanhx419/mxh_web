<div class="container">
    <div class="page-header text-center">
        <h1
            ...
            <i class="fas fa-dharmachakra"
                style="-webkit-text-fill-color: initial; color: var(--accent-secondary);"></i>
            Vòng Quay May Mắn
        </h1>
        <p class="text-secondary mt-1">Thử vận may của bạn ngay hôm nay! Mỗi lượt quay chỉ <?= formatMoney($spinCost) ?>
        </p>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 1fr 380px; gap: 28px; align-items: start;">
        ...
        <div style="text-align: center;">
            ...
            <button id="spin-btn" class="btn btn-lg mt-3"
                style="background: var(--gradient-primary); color: #fff; border-radius: 50px; padding: 14px 48px; font-size: 1.05rem; box-shadow: var(--shadow-glow);">
                <i class="fas fa-play"></i> QUAY NGAY
                <?= $freeSpins > 0 ? '(Lượt free)' : '(' . formatMoney($spinCost) . ')' ?>
            </button>
            <?php if ($freeSpins > 0): ?>
                <div class="mt-1" style="font-size:.85rem;color:var(--accent-success);font-weight:600;">
                    <i class="fas fa-ticket-alt"></i> Bạn có <strong id="wheel-free-spins"><?= $freeSpins ?></strong> lượt
                    quay miễn phí
                </div>
            <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
                        <?php foreach ($prizes as $prize): ?>
                            <div
                                style="padding: 8px 12px; border-radius: 8px; font-size: 0.82rem; font-weight: 600; text-align: center; color: #fff; background: <?= e($prize['color']) ?>;">
                                <?= e($prize['name']) ?>
                            </div>
                        <?php endforeach; ?>
                    </div>
